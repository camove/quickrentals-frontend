  ...
  const fetchFlatsWithURLParams = async (page, limit) => {
    try {
      ...
      const response = await fetch(
        `https://quickrentals-backend.onrender.com/flats?${queryParams.toString()}`,
        {
          headers: {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.resultsInfo}>
        <span className={styles.resultsCount}>
          Found {pagination.totalResults} apartment
              ...
              <div className={styles.flatImage}>
                ...
                <button
                  className={`${styles.favoriteButton} ${
                    favorites.has(flat._id) ? styles.active : ""
                  }`}
            ...
            <div className={styles.modalDetails}>
              ...
              <div className={styles.detailsGrid}>
                ...
                <div className={styles.detailItem}>
                  <strong>Owner:</strong>
                  <p>
                    {selectedFlat.ownerId?.firstName}{" "}
                    {selectedFlat.ownerId?.lastName}
                  </p>
                </div>
              </div>
              ...
              <div className={styles.modalActions}>
                ...
                <button
                  className={`${styles.modalFavoriteButton} ${
                    favorites.has(selectedFlat._id) ? styles.active : ""
                  }`}
                  onClick={(e) => toggleFavorite(e, selectedFlat._id)}
                >
                  {favorites.has(selectedFlat._id)
